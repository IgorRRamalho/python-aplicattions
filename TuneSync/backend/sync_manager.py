...
class SyncManager:
    ...
    def sync_playlists(self):
        ...
        try:
            ...
            print(f"Erro ao sincronizar playlists: {e}")
    ...
    def playlist_exists(self, playlist_name, apple_playlists):
        ...
        try:
            ...
            print(f"Erro ao verificar existência da playlist '{playlist_name}': {e}")
            return False
    ...
    def get_apple_playlist_id(self, playlist_name, apple_playlists):
        ...
        try:
            ...
            print(f"Erro ao obter o ID da playlist '{playlist_name}': {e}")
            return None
    ...
    def sync_tracks(self, spotify_playlist, apple_playlist_id):
        ...
        try:
            ...
            print(f"Erro ao sincronizar faixas para a playlist '{spotify_playlist['name']}': {e}")
    ...
    def add_tracks_to_apple_playlist(self, apple_playlist_id, spotify_tracks):
        ...
        try:
            ...
            print(f"Erro ao adicionar faixas à playlist do Apple Music (ID: {apple_playlist_id}): {e}")
